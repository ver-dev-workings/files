...
var _app={
	...
	setUser:function(s,p){
		_app.user.uName=s;
		if(p.organisationid){
		  _app.user.orgID=p.organisationid;
		}
	},
	loginStatus:function(p){
		/*var keepAlive;*/
		if($("#nav_username").length){
			_app.setUser($("#nav_username").html().trim(), p);
...
$(document).ready(function(){
	// _app initialisation has been moved after the citizen data finished loaded.
// 	_app.init();
});
/*/portal scripts*/
