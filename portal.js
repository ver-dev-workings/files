...
var _app = {
    ...
    squizDomains: ['lobe-dev-web01.squiz.cloud', 'lbe.clients.squiz.net', 'www.enfield.gov.uk'],
    alerts: {
        logout: { t: "How to logout", d: "<p>To log out of your Enfield Connected account, you must close and completely exit your browser. Please see our <a href='https://lobe-dev-web01.squiz.cloud/terms-of-use#logging-out' target='_blank' style='text-decoration:underline'>terms of use</a> for more information.</p>", b: { OK: function() { $(this).dialog("close") } }, f: false },
