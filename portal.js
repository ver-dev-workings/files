...
var _app = {
    ...
    alerts: {
        logout: { t: "How to logout", d: "<p>To log out of your Enfield Connected account, you must close and completely exit your browser. Please see our <a href='"+_app.squizDomain+"/terms-of-use#logging-out' target='_blank'>terms of use</a> for more information.</p>", b: { OK: function() { $(this).dialog("close") } }, f: false },
