...
<!-- GovMetric Web Code Snippet starts here right hand bottom corner
            ...
            <div class="gm_sidebar gm_sidebar_cnr" style="z-index:0">
                <a href="https://websurveys2.govmetric.com/theme/gm/2634" class="gm_sidebar_anchor" role="button" rel="nofollow">
                    <img src="https://websurveys2.govmetric.com/imgs/triggers/cnr.svg" alt="Feedback button">
                </a>
            </div>
...
function addAccordion(){
	...
	if ((KDF.kdf().access === 'agent' && KDF.getParams().customerid !== undefined && KDF.getParams().customerid !== '') || (KDF.kdf().viewmode === 'R' || KDF.kdf().viewmode === 'U') && KDF.getVal('txt_cust_info_first_name') !== '') {
